/*
 * Since the Employee was changed to an interface, and lower classes were
 * instantiated using Liskov's Substitution principle, this module is not 
 * needed.  Either that, or I messed up.  I have not looked at the Instructor
 * Solution yet.
 */
